...
var Connection = module.exports = function() {
    ...
    //"Outbound" connection (coming from FSW)
        ...
        // As this constructor writes to the socket, the error handlers added after the constructor
        // are unable to catch the very initial errors on socket writes and leads to uncaught exceptions and crashes.
        // Hence, this dummy error handler is to ignore very initial errors.
        // This is a temporary solution as implementing it in a proper way would need
        // refactoring the entire constructor by moving the socket writes outside.
        this.on('error', () => {});
